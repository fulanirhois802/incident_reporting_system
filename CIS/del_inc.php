...
if ((isset($_GET['SQGatdJueisPlejsherhg'])) && ($_GET['SQGatdJueisPlejsherhg'] != "")) {
  $deleteSQL = sprintf("DELETE FROM incident_list WHERE inc_id=%s",
                       GetSQLValueString($_GET['SQGatdJueisPlejsherhg'], "int"));
...
$colname_conf = "-1";
if (isset($_GET['SQGatdJueisPlejsherhg'])) {
  $colname_conf = $_GET['SQGatdJueisPlejsherhg'];
}
mysqli_select_db($db_connect, $database_db_connect);
$query_conf = sprintf("SELECT * FROM incident_list WHERE inc_id = %s", GetSQLValueString($colname_conf, "int"));
$conf = mysqli_query($db_connect, $query_conf) or die(mysql_error());
$row_conf = mysqli_fetch_assoc($conf);
$totalRows_conf = mysqli_num_rows($conf);
?>
<!DOCTYPE html><head>
...
<table width="80%" border="0">
    <tr>
      ...
      <td><div class="form-group"> 
   	<div class="col-sm-5">
	<input name="inc_id" class="form-control" type="text" value="<?php echo $row_conf['inc_id']; ?>"/
	>
	</div>
	</div></td>
    </tr>
    <tr>
	  ...
	  <div class="form-group"> 
   	<div class="col-sm-5">
	<input name="inc_name" class="form-control" type="text" value="<?php echo $row_conf['inc_name']; ?>"/>
	</div>
	</div></td>
    </tr>
